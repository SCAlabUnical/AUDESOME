 ...
 * @since 3.2
 */
public class DBSCANRoI<T extends Clusterable> extends Clusterer<T> {
     ...
     */
    public DBSCANRoI(final double eps, final int minPts)
        throws NotPositiveException {
        this(eps, minPts, new LngLatDistance());
    }
     ...
     * @throws NotPositiveException if {@code eps < 0.0} or {@code minPts < 0}
     */
    public DBSCANRoI(final double eps, final int minPts, final DistanceMeasure measure)
        throws NotPositiveException {
        super(measure);
